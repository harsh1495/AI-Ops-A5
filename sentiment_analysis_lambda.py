...
preprocess = TextPreprocessing(max_length_tweet=40, max_length_dictionary=10000)
...
def lambda_handler(event, context):
    ...
    response = sage_maker_client.invoke_endpoint(EndpointName='aiops-a5-endpoint',\
    ...
    s3_client.put_object(Body=json.dumps(response), Bucket='aiops-a5-skand', Key='logs/{}.txt'.format(response['request_time_stamp']))
